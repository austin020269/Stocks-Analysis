...
The refactoring is a benefit in that you can use previous code to add to by some simple modifications, however without a strong understanding of the original code it can be quite challenging to complete and run properly.
